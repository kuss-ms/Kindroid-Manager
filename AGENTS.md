...
See `docs/manual-checks.md` for the full list of integration / smoke checks that the automated Rust + Vitest suite cannot reach (live Kindroid API calls, WebView-only UI states, destructive round-trips). Append new entries there, not here.
