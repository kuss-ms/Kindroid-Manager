...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            tauri_wrappers::send_chat_message,
            tauri_wrappers::rewind_chat,
            tauri_wrappers::suggest_chat_user_message,
            ...
            tauri_wrappers::list_character_revisions,
            tauri_wrappers::get_character_revision,
            tauri_wrappers::restore_character_revision,
